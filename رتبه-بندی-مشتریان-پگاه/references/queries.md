...
> **کوئری ۰ و کوئری ۱ روی `pakhsh` اجرا شده‌اند** (مرداد ۱۴۰۵، همه‌ی لاین‌ها:
> ۱۹٬۳۱۴ مشتری). کوئری ۲ — مستر مشتری — هنوز ساخته نشده، پس جمعیت فعلاً فقط
> **خریدکرده‌ها**ست. بند **اعتبارسنجی** پایین همین فایل هنوز برای هر بازه‌ی تازه
> لازم است.
...
- **همه ته جدول** (رتبه ۱) — آستانه برای این نوع مشتری خیلی بالاست، یا بازه
  ...
  داده‌ی مرداد ۱۴۰۵ علتش آستانه بود: میانه‌ی خرد ۶۷ قلم و ۸ SKU در یک ماه.
- **همه سرِ جدول** (رتبه ۵) — اول جمعیت را نگاه کن، نه آستانه را. ۱۰ خرد برترِ
  مرداد ۱۴۰۵ همه رتبه ۵ اقلام گرفتند چون کم‌ترینشان ۱۱٬۱۸۱ قلم خرید داشت؛ روی کل
  ۱۹٬۰۴۹ خرد فقط ۶۳ نفر (۰.۳٪) سوپر ممتاز شدند. به یک لیستِ از پیش مرتب‌شده رتبه
  ندادن، شرطِ اول است.
